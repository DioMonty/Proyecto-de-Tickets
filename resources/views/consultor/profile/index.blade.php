                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane show active" id="settings">
                                <form method="POST" action="{{route('consultor.profile.update')}}" enctype="multipart/form-data">
                                    @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane show active">
                                ...
                                @endif
                                <form method="POST" action="{{route('consultor.password.update')}}" enctype="multipart/form-data">
                                    @csrf
