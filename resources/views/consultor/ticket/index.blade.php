...
@section('title', 'Ver Tickets | Rensar Consulting')
            ...
            <div class="col-xxl-12">
                ...
                <div class="row">
                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    ...
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Ver Tickets</li>
                                    </ol>
                                </nav>
                                </div>
                                <h4 class="page-title">Ver Tickets</h4>
                    ...
                    <div class="card p-3 shadow-sm rounded">
                        <form method="GET" action="{{ route('consultor.ticket.index') }}">
                            <div class="mb-3">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center align-middle">
                                                <a href="{{ route('consultor.ticket.show', Crypt::encrypt($pendiente->id)) }}" class="action-icon" target="_blank" rel="noopener">
                                ...
                                <table id="basic-datatable-two" class="table dt-responsive nowrap w-100"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center align-middle">
                                                <a href="{{ route('consultor.ticket.show', Crypt::encrypt($estimado->id)) }}" class="action-icon" target="_blank" rel="noopener">
                                                    <i class="mdi mdi-eye" data-bs-toggle="tooltip" data-bs-placement="left"
                                                        title="Detalle"></i>
                                                </a>
                                            </td>
                                ...
                                <table id="basic-datatable-three" class="table dt-responsive nowrap w-100"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center align-middle">
                                                <a href="{{ route('consultor.ticket.show', Crypt::encrypt($aprobado->id)) }}" class="action-icon" target="_blank" rel="noopener">
                                                    <i class="mdi mdi-eye" data-bs-toggle="tooltip" data-bs-placement="left"
                                                        title="Detalle"></i>
                                                </a>
                                            </td>
                                ...
                                <table id="basic-datatable-four" class="table dt-responsive nowrap w-100"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center align-middle">
                                                <a href="{{ route('consultor.ticket.show', Crypt::encrypt($planificado->id)) }}" class="action-icon" target="_blank" rel="noopener">
                                                    <i class="mdi mdi-eye" data-bs-toggle="tooltip" data-bs-placement="left"
                                                        title="Detalle"></i>
                                                </a>
                                            </td>
                                ...
                                <table id="basic-datatable-five" class="table dt-responsive nowrap w-100"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center align-middle">
                                                <a href="{{ route('consultor.ticket.show', Crypt::encrypt($observado->id)) }}" class="action-icon" target="_blank" rel="noopener">
                                                    <i class="mdi mdi-eye" data-bs-toggle="tooltip" data-bs-placement="left"
                                                        title="Detalle"></i>
                                                </a>
                                            </td>
                                ...
                                <table id="basic-datatable-six" class="table dt-responsive nowrap w-100"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center align-middle">
                                                <a href="{{ route('consultor.ticket.show', Crypt::encrypt($prueba_cliente->id)) }}" class="action-icon" target="_blank" rel="noopener">
                                                    <i class="mdi mdi-eye" data-bs-toggle="tooltip" data-bs-placement="left"
                                                        title="Detalle"></i>
                                                </a>
                                            </td>
                                ...
                                <table id="basic-datatable-seven" class="table dt-responsive nowrap w-100"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center align-middle">
                                                <a href="{{ route('consultor.ticket.show', Crypt::encrypt($cerrado->id)) }}" class="action-icon" target="_blank" rel="noopener">
                                                    <i class="mdi mdi-eye" data-bs-toggle="tooltip" data-bs-placement="left"
                                                        title="Detalle"></i>
                                                </a>
                                            </td>
