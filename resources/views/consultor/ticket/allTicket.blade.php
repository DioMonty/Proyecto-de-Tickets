...
@section('title', 'Todos los Tickets | Rensar Consulting')
                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    ...
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Todos los Tickets</li>
                                    </ol>
                                </nav>
                                </div>
                                <h4 class="page-title">Todos los Tickets</h4>
                                <p class="mt-2 mb-3 text-muted">
                                    Una bandeja de estados de todos los consultores donde se visualizan los tickets organizados según su estado de atención.
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="row gy-2 gx-3">
                                <div class="col-md-3">
                                    ...
                                    <select id="filtro-cliente" name="cliente" class="form-select form-select-sm" onchange="this.form.submit()">
                                        <option value="">Todos</option>
                                        @foreach($clientes as $cliente)
                                            <option value="{{ $cliente->descripcion }}" {{ request('cliente') == $cliente->id ? 'selected' : '' }}>
                                                {{ $cliente->descripcion }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center align-middle">
                                                <a href="{{ route('consultor.ticket.all.show', Crypt::encrypt($pendiente->id)) }}" class="action-icon" target="_blank" rel="noopener">
                                ...
                                <table id="basic-datatable-two" class="table dt-responsive nowrap w-100"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center align-middle">
                                                <a href="{{ route('consultor.ticket.all.show', Crypt::encrypt($estimado->id)) }}" class="action-icon" target="_blank" rel="noopener">
                                                    <i class="mdi mdi-eye" data-bs-toggle="tooltip" data-bs-placement="left"
                                                        title="Detalle"></i>
                                                </a>
                                            </td>
                                ...
                                <table id="basic-datatable-three" class="table dt-responsive nowrap w-100"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center align-middle">
                                                <a href="{{ route('consultor.ticket.all.show', Crypt::encrypt($aprobado->id)) }}" class="action-icon" target="_blank" rel="noopener">
                                                    <i class="mdi mdi-eye" data-bs-toggle="tooltip" data-bs-placement="left"
                                                        title="Detalle"></i>
                                                </a>
                                            </td>
                                ...
                                <table id="basic-datatable-four" class="table dt-responsive nowrap w-100"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center align-middle">
                                                <a href="{{ route('consultor.ticket.all.show', Crypt::encrypt($planificado->id)) }}" class="action-icon" target="_blank" rel="noopener">
                                                    <i class="mdi mdi-eye" data-bs-toggle="tooltip" data-bs-placement="left"
                                                        title="Detalle"></i>
                                                </a>
                                            </td>
                                ...
                                <table id="basic-datatable-five" class="table dt-responsive nowrap w-100"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center align-middle">
                                                <a href="{{ route('consultor.ticket.all.show', Crypt::encrypt($observados->id)) }}" class="action-icon" target="_blank" rel="noopener">
                                                    <i class="mdi mdi-eye" data-bs-toggle="tooltip" data-bs-placement="left"
                                                        title="Detalle"></i>
                                                </a>
                                            </td>
                                ...
                                <table id="basic-datatable-six" class="table dt-responsive nowrap w-100"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center align-middle">
                                                <a href="{{ route('consultor.ticket.all.show', Crypt::encrypt($prueba_cliente->id)) }}" class="action-icon" target="_blank" rel="noopener">
                                                    <i class="mdi mdi-eye" data-bs-toggle="tooltip" data-bs-placement="left"
                                                        title="Detalle"></i>
                                                </a>
                                            </td>
                                ...
                                <table id="basic-datatable-seven" class="table dt-responsive nowrap w-100"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center align-middle">
                                                <a href="{{ route('consultor.ticket.all.show', Crypt::encrypt($cerrado->id)) }}" class="action-icon" target="_blank" rel="noopener">
                                                    <i class="mdi mdi-eye" data-bs-toggle="tooltip" data-bs-placement="left"
                                                        title="Detalle"></i>
                                                </a>
                                            </td>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function filtrarTablas() {
            ...
            ['basic-datatable-one', 'basic-datatable-two', 'basic-datatable-three', 'basic-datatable-four', 
            'basic-datatable-five', 'basic-datatable-six', 'basic-datatable-seven', 'basic-datatable-eight'].forEach(idTabla => {
                const filas = document.querySelectorAll(`#${idTabla} tbody tr`);
                filas.forEach(fila => {
                    const clienteTexto = fila.cells[3]?.innerText.toLowerCase() || '';
                    const codigoTexto = fila.cells[1]?.innerText.toLowerCase() || '';

                    const coincideCliente = clienteValor === '' || clienteTexto.includes(clienteValor);
                    const coincideCodigo = codigoValor === '' || codigoTexto.includes(codigoValor);

                    if (coincideCliente && coincideCodigo) {
                        fila.style.display = '';
                    } else {
        ...
        filtroCliente.addEventListener('change', filtrarTablas);
        filtroCodigo.addEventListener('input', filtrarTablas);
    });
</script>
