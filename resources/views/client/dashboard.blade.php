                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <p class="text-muted mb-0">Resumen general del ultimo trimestre</p>
                        </div>
                    </div>
                    ...
                    <div class="mt-3">
                        ...
                        <p class="text-muted mb-0">
                            ...
                            reflejando un mayor nivel de actividad y participacion de las areas
                            involucradas.
                        </p>
                    </div>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-6 text-end">
                            <p class="text-muted fw-semibold mb-1">Comparacion</p>
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div
                                ...
                                <div class="card-body">
                                    ...
                                    <h2 class="m-b-20">{{ $estados->facturados ?? 0 }}</h2>
                                    <span class="badge bg-danger">Live</span>
                                    <span class="text-muted">Actualizado en tiempo real</span>
                                </div> <!-- end card-body-->
                            </div> <!--end card-->
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="card text-white bg-danger overflow-hidden">
                <div class="card-body">
                    <div class="toll-free-box text-center">
                        <h4> <i class="mdi mdi-headset"></i> &iquest;Necesitas ayuda? Cont&aacute;ctanos.</h4>
                    </div>
                </div> <!-- end card-body-->
            </div>
        </div> <!-- end col-->
